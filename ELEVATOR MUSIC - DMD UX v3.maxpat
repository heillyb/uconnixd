...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.5, 170.5, 372.0, 62.0 ],
					"style" : "",
					"text" : "This is front-end design template for a demo application that will be part of a live performance at the University of Connecticut Stamford Campus, showcasing projects from Professor Pagano's IXD [Interaction Design] Fall 2017 class. ",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 160.0, 78.18187, 292.0, 80.0 ],
					"style" : "UCONN DMD IXD",
					"text" : "DMD IXD "
				}
